...
internal partial class AdventureWorksContext : DbContext
{
    ...
    /// <summary>
    /// Gets or sets the <see cref="T:Microsoft.EntityFrameworkCore.DbSet`1" /> that can be used to query and save instances of <see cref="AdventureWorks.Repository.Data.Entities.Document"/>.
    /// </summary>
    /// <value>
    /// The <see cref="T:Microsoft.EntityFrameworkCore.DbSet`1" /> that can be used to query and save instances of <see cref="AdventureWorks.Repository.Data.Entities.Document"/>.
    /// </value>
    public virtual DbSet<AdventureWorks.Repository.Data.Entities.Document> Documents { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfiguration(new AdventureWorks.Repository.Data.EntityConfiguration.DocumentConfiguration());
