    ...
    : Profile
{
    ...
    {
        CreateMap<AdventureWorks.Repository.Data.Entities.VSalesPersonSalesByFiscalYears, AdventureWorks.Repository.Domain.Models.VSalesPersonSalesByFiscalYearsModel>();
